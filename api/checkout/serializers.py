...
class BoletoSerializer(serializers.ModelSerializer):
	class Meta:
		model = BoletoBB
		fields = ('id', 'codigo_banco', 'carteira', 'aceite', 'valor_documento', 'valor', \
				'data_vencimento', 'data_documento', 'data_processamento', 'numero_documento', \
				'agencia_cedente', 'conta_cedente', 'cedente', 'cedente_documento', 'cedente_cidade', \
				'cedente_uf', 'cedente_endereco', 'cedente_bairro', 'cedente_cep', 'sacado_nome', \
				'sacado_documento', 'sacado_cidade', 'sacado_uf', 'sacado_endereco', 'sacado_bairro', \
				'sacado_cep', 'quantidade', 'especie_documento', 'especie', 'moeda', 'local_pagamento', \
