...
class ProductWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'name', 'company', 'price', 'manufacturer', 'products_related', 'available', 'active', 'obs', 'image')
...
class ProductReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        depth = 2
        fields = ('id', 'name', 'company', 'price', 'manufacturer', 'available', 'obs', 'image', 'active', 'distance')
...
class ProductDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        depth = 2
        fields = ('id', 'name', 'company', 'price', 'manufacturer', 'available', 'obs', 'image', 'products_related', 'active')
...
class ProductSimpleSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = ('id', 'name', 'company', 'price', 'manufacturer', 'available', 'obs', 'image', 'active')
